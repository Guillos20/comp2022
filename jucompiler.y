...
DeclMult:  MethodDecl DeclMult                    {$$ = $1; $1->sibling = $2;} //not sur
        |  FieldDecl  DeclMult                    {$$ = $1; $1->sibling = $2;}
        |  SEMICOLON  DeclMult                    {$$ = $2;} 
        |                                         {$$ = NULL;}
        ;
...
COMID: COMMA ID COMID                             {$$ = createNode("FieldDecl",NULL,createNode("Type",NULL,NULL,NULL),$3);} //not done
    |                                             {$$ = NULL;}
;
